...
class Sinter < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "73e8764dcdf90e06fb222d9bb14c890029d44390bf84a69132bbc1f9d5b48092"
    else
      url "https://github.com/shellfu/sinter/releases/download/v#{version}/sinter-x86_64-apple-darwin.tar.gz"
      sha256 "38c79be8bfbb25ded00d6386f25b77c9dba669b1c6a7f69c209d03faf9ca56a4"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "95d56c9f12910a1dd4bfcbbc5ab52d99526a397c719c9fbc7183790b3af386ab"
    else
      url "https://github.com/shellfu/sinter/releases/download/v#{version}/sinter-x86_64-unknown-linux-musl.tar.gz"
      sha256 "97f0e09e6b91135a67ab63c413896f8c9690af3ee8d4895baebe006e6810074b"
    end
  end
